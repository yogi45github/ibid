...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
    ...
    <div class="split-row form-row-wide">
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( 'First Name', 'ibid' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php esc_html_e( 'Last Name', 'ibid' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Shop Name', 'ibid' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php esc_html_e( 'Shop URL', 'ibid' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php esc_html_e( 'Phone Number', 'ibid' ); ?><span class="required">*</span></label>
    ...
    if ( 'on' === $show_terms_condition && $terms_condition_url ) { ?>
        <p class="form-row form-group form-row-wide">
            ...
            <label style="display: inline" for="tc_agree"><?php echo wp_kses_post( sprintf( __( 'I have read and agree to the <a target="_blank" href="%s">Terms &amp; Conditions</a>.', 'ibid' ), esc_url( $terms_condition_url ) ) ); ?></label>
        </p>
    <?php }
...
if(class_exists('Mt_Freelancer_Mode')) {
    if ((get_option("freelancer_enabled") == "yes") ) {
        $custom_text_customer = __('Register as a Freelancer', 'ibid');
        $custom_text_vendor = __('Register as a Job Poster', 'ibid');
    } else {
        $custom_text_customer = __('I am a customer', 'ibid');
        $custom_text_vendor = __('I am a vendor', 'ibid');
    }
}else{
    $custom_text_customer = __('I am a customer', 'ibid');
    $custom_text_vendor = __('I am a vendor', 'ibid');
