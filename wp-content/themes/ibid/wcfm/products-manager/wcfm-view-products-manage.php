...
if( !in_array( $product_taxonomy->name, array( 'product_cat', 'product_tag', 'wcpv_product_vendors' ) ) && apply_filters( 'wcfm_is_allow_taxonomy_'.$product_taxonomy->name, true ) ) {
	if( $product_taxonomy->public && $product_taxonomy->show_ui && $product_taxonomy->meta_box_cb && !$product_taxonomy->hierarchical ) {
		...
		"pro_id" => array('type' => 'hidden', 'value' => $product_id)
            ...
            //Attach PDF
            $meta_pdf_attach = get_post_meta( $product_id, 'ibid_pdf_attach', true );

            ?>

            <div class="wcfm-content">
				<div class="wcfm_product_manager_content_fields">
					 <h3 class="ebid-relist-auction"><?php esc_html_e( 'Input Attach PDF', 'ibid' ); ?></h3>
					<input type="text" class="form-control wc_input_attach_pdf short wc_attach_pdf" style="" name="ibid_pdf_attach" id="ibid_pdf_attach" value="<?php echo esc_attr($meta_pdf_attach); ?>">
				</div>
			</div>
            <?php if ( class_exists( 'ReduxFrameworkPlugin' ) ) { ?>
                <?php if (ibid_redux('ibid_enable_fundraising') != 'disable' && ibid_redux('ibid_fundraising_in_archives') != false) { ?>
                    <div class="ibid-auction-settings">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p class=" form-field _auction_item_condition_field">
                                        <select style="" id="product_cause" name="product_cause" class="form-control select short">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <p class="form-field _auction_proxy_field ">
                                    ...
                                    <input type="checkbox" class="checkbox wcfm-checkbox" style="" name="_auction_proxy" id="_auction_proxy" value="<?php if($meta_auction_proxy == 'yes'){echo esc_attr__('yes', 'ibid');} ?>" <?php if($meta_auction_proxy == 'yes'){echo esc_attr__('checked', 'ibid');} ?>>
                                </p>
                            </div>
                            <div class="col-md-2">
                                <p class="form-field _auction_sealed_field ">
                                    ...
                                    <input type="checkbox" class="checkbox wcfm-checkbox" style="" name="_auction_sealed" id="_auction_sealed" value="<?php if($meta_auction_sealed == 'yes'){echo esc_attr__('yes', 'ibid');} ?>" <?php if($meta_auction_sealed == 'yes'){echo esc_attr__('checked', 'ibid');} ?>>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <p class=" form-field field_auction_automatic_relist">
                                <input type="checkbox" class="checkbox wcfm-checkbox" style="" name="_auction_automatic_relist" id="_auction_automatic_relist" value="<?php if($meta_auction_automatic_relist == 'yes'){echo esc_attr__('yes', 'ibid');} ?>" <?php if($meta_auction_automatic_relist == 'yes'){echo esc_attr__('checked', 'ibid');} ?>><label for="_auction_automatic_relist"><?php esc_html_e( 'Automatic relist auction', 'ibid' ); ?></label>
                            </p>
                        </div>
