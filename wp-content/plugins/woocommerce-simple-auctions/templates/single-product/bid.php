...
<?php if(($product->is_closed() === FALSE ) and ($product->is_started() === TRUE )) : ?>			
	...
	<div class='auction-ajax-change' >
		...
		<p class="auction-end"><?php echo apply_filters('time_left_text', __( 'Auction ends:', 'wc_simple_auctions' ), $product); ?> <?php echo  date_i18n( $dateformat,  strtotime( $product->get_auction_end_time() ));  ?>  <?php echo  date_i18n( $timeformat,  strtotime( $product->get_auction_end_time() ));  ?> <br />
			<?php printf(__('Timezone: %s','wc_simple_auctions') , get_option('timezone_string') ? get_option('timezone_string') : __('UTC ','wc_simple_auctions').$gmt_offset) ?>
		</p>
...
<?php elseif (($product->is_closed() === FALSE ) and ($product->is_started() === FALSE )):?>
	...
	<p class="auction-starts"><?php echo apply_filters('time_text', __( 'Auction starts:', 'wc_simple_auctions' ), $product_id); ?> <?php echo  date_i18n( $dateformat,  strtotime( $product->get_auction_start_time() ));  ?>  <?php echo  date_i18n( $timeformat,  strtotime( $product->get_auction_start_time() ));  ?></p>
	<p class="auction-end"><?php echo apply_filters('time_text', __( 'Auction ends:', 'wc_simple_auctions' ), $product_id); ?> <?php echo  date_i18n( $dateformat,  strtotime( $product->get_auction_end_time() ));  ?>  <?php echo  date_i18n( $timeformat,  strtotime( $product->get_auction_end_time() ));  ?> </p>
