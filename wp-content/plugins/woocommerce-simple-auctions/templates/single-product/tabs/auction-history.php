...
<?php if(($product->is_closed() === TRUE ) and ($product->is_started() === TRUE )) : ?>
	...
	<?php }elseif($product->get_auction_current_bider()){ ?>
		<p><?php _e('Highest bidder was', 'wc_simple_auctions') ?>: <span><?php echo apply_filters( 'woocommerce_simple_auctions_displayname', get_userdata($product->get_auction_current_bider())->display_name, $product ) ?></span></p>
	<?php } ?>
