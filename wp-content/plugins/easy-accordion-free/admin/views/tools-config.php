	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'class'       => 'eap_post_ids',
				'type'        => 'select',
				'title'       => __( ' ', 'easy-accordion-free' ),
				// 'help'        => __( 'Export your existing accordion groups and import the same accordion groups into a different site.', 'easy-accordion-free' ),
	...
	array(
		...
		'fields' => array(
			array(
				...
				// 'help'  => __( 'Import accordion group shortcode(s) which is exported with Easy Accordion Pro.', 'easy-accordion-free' ),
			),
		),
	)
);
