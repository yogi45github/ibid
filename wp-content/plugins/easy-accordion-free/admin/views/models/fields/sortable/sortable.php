	...
	class SP_EAP_Field_sortable extends SP_EAP_Fields {
		...
		public function render() {
			...
			foreach ( $pre_sortby as $key => $field ) {
				...
				echo '<div class="eapro--sortable-item">';

				echo '<div class="eapro--sortable-content">';
				...
				echo '<div class="eapro--sortable-helper"><i class="fa fa-arrows-alt"></i></div>';
