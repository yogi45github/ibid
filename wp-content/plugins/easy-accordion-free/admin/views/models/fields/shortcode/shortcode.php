...
if ( ! class_exists( 'SP_EAP_Field_shortcode' ) ) {
	class SP_EAP_Field_shortcode extends SP_EAP_Fields {
		...
		public function render() {
			...
			echo ( ! empty( $post_id ) ) ? '<div class="eap-scode-wrap"><span class="eap-sc-title">Shortcode:</span><span class="eap-shortcode-selectable">[sp_easyaccordion id="' . $post_id . '"]</span></div><div class="eap-scode-wrap"><div class="sp_eap-after-copy-text"><i class="fa fa-check-circle"></i>  Shortcode  Copied to Clipboard! </div><span class="eap-sc-title">Template Include:</span><span class="eap-shortcode-selectable">&lt;?php echo do_shortcode(\'[sp_easyaccordion id="' . $post_id . '"]\'); ?&gt;</span></div>' : '';
		}
