...
class modeltheme_shortcode_featured_product_no_image_widget extends Widget_Base {
	
	public function get_name() {
		return 'featured-auction-no-image';
	}
	
	public function get_title() {
		return 'iBid - Featured Auction - no image';
	}
	...
	protected function render() {
        ...
        $html = '';
	    $html .= '<div class="featured_product_shortcode v2 col-md-12 wow " style=" background-color: '.$background_color.';">';
